...
* Kindly note, the custom JavaScript and other options in the plugin page have been moved to PitchPrint settings page: https://pitchprint.net/admin/settings
* Other minor bug fixes
...
= 8.0.0 =
Kindly re-enter in your API and Sercret keys after the upgrade.
Also note, you need to upgrade your Domain to use version 8 here: https://pitchprint.net/admin/domains.
